function init() {
  ...
  var axisHelper = new THREE.AxisHelper(13);
  //var vec3 = new THREE.Vector3(-4,2,0);
  //axisHelper.position.set(-4,2,0);
  ...
  spotLight.shadow.mapSize = new THREE.Vector2(1024, 1024); //阴影的锯齿优化new THREE.Vector2(2048, 2048)
